...
- Explorer exists only for one Maze. Teaching Explorer to enter and leave mazes
  would require refactoring.

- Maze can have multiple Explorers. Its instance can be shared between
  Explorers as it's not modified by any of them.
